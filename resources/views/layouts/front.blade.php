                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <form method="POST" action="{{route('logout')}}">
                                        {{csrf_field()}}
                                        <button class="btn btn-success btn-block">Cerrar Sesion</button>
                                    </form>
                                </li>
                            </ul>
                        </li>
...
<!-- Footer -->
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; {{date('Y')}} <a href="http://serenacare.net">Serena Care</a>.</strong> Todos los derechos reservados.
            </div>
            <!-- /.container -->
        </footer>
    </div>
